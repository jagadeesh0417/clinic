...
export default function AppointmentForm() {
    ...
    return (
      <section className="relative py-24 bg-[#050505]">
        <div className="max-w-lg mx-auto px-4 text-center">
          ...
          >
            <div className="w-16 h-16 rounded-full bg-[#CBA135]/20 flex items-center justify-center mx-auto mb-6">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#CBA135" strokeWidth="2">
                <polyline points="20 6 9 17 4 12"/>
              </svg>
            </div>
            <h2 className="font-['Playfair_Display'] text-2xl text-white mb-3">Thank You</h2>
            <p className="font-['Inter'] text-sm text-white/50 mb-2">Your enquiry has been received.</p>
            <p className="font-['Inter'] text-xs text-white/40">The team will contact you to schedule and provide further details.</p>
            <button
              onClick={() => setSubmitted(false)}
              className="mt-6 px-6 py-2.5 rounded-full border border-white/10 text-white/70 font-['Inter'] text-sm transition-all hover:border-[#CBA135]/40 hover:text-white"
            >
              Submit Another
            </button>
          </motion.div>
  ...
  return (
    <section className="relative py-24 bg-[#050505] overflow-hidden">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#CBA135]/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-['Playfair_Display'] text-3xl md:text-4xl text-white mb-3">
            Book an <span className="text-[#CBA135]">Appointment</span>
          </h2>
          <p className="text-white/50 font-['Inter'] text-sm max-w-lg mx-auto">
        ...
        >
          <div className="inline-flex rounded-2xl p-1" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
            <button
              ...
              className={`px-6 py-2.5 rounded-xl text-sm font-['Space_Grotesk'] font-medium tracking-wider transition-all duration-300 ${
                activeTab === "enquiry" ? "bg-[#CBA135] text-black" : "text-white/50 hover:text-white"
              }`}
            >
              Quick Enquiry
            </button>
            <button
              ...
              className={`px-6 py-2.5 rounded-xl text-sm font-['Space_Grotesk'] font-medium tracking-wider transition-all duration-300 ${
                activeTab === "appointment" ? "bg-[#CBA135] text-black" : "text-white/50 hover:text-white"
              }`}
            >
              Book Appointment
            </button>
        ...
        {activeTab === "appointment" && (
          ...
          >
            <div className="flex items-center gap-3">
              <span className="font-['Inter'] text-xs text-white/40">Treatment list:</span>
              <button
                onClick={() => setSite("drvikas")}
                className={`px-4 py-1.5 rounded-full text-xs font-['Space_Grotesk'] font-medium tracking-wider transition-all duration-300 ${
          ...
          >
            <form onSubmit={handleEnquirySubmit} className="max-w-lg mx-auto space-y-5">
              <motion.div variants={fadeUp} custom={0} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Full Name</label>
                <input
                  type="text"
                  value={enquiry.fullName}
                  onChange={e => handleEnquiryChange("fullName", e.target.value)}
                  placeholder="Your full name"
                  className={`w-full px-4 py-3 rounded-2xl bg-white/5 border font-['Inter'] text-sm text-white placeholder:text-white/20 transition-all duration-300 focus:outline-none focus:border-[#CBA135]/40 ${
                    errors.fullName ? "border-red-500/50" : "border-white/10"
                  }`}
                />
                {errors.fullName && <p className="mt-1 font-['Inter'] text-xs text-red-400">{errors.fullName}</p>}
              </motion.div>

              <motion.div variants={fadeUp} custom={1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Email</label>
                <input
                  type="email"
                  value={enquiry.email}
                ...
                />
                {errors.email && <p className="mt-1 font-['Inter'] text-xs text-red-400">{errors.email}</p>}
              </motion.div>

              <motion.div variants={fadeUp} custom={2} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Phone / WhatsApp</label>
                <input
                  type="tel"
                  value={enquiry.phone}
                ...
                />
                {errors.phone && <p className="mt-1 font-['Inter'] text-xs text-red-400">{errors.phone}</p>}
              </motion.div>

              <motion.div variants={fadeUp} custom={3} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Message</label>
                <textarea
                  rows={4}
                  value={enquiry.message}
                  onChange={e => handleEnquiryChange("message", e.target.value)}
                  placeholder="How can we help you?"
                  className="w-full px-4 py-3 rounded-2xl bg-white/5 border border-white/10 font-['Inter'] text-sm text-white placeholder:text-white/20 transition-all duration-300 focus:outline-none focus:border-[#CBA135]/40 resize-none"
                />
              </motion.div>

              <motion.div variants={fadeUp} custom={4} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <p className="font-['Inter'] text-xs text-white/30 leading-relaxed mb-5">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-2xl bg-[#CBA135] text-black font-['Space_Grotesk'] text-sm font-semibold tracking-wider uppercase transition-all duration-300 hover:bg-[#d4a83a] hover:shadow-lg hover:shadow-[#CBA135]/25"
                >
                  Send Enquiry
                </button>
              </motion.div>
        ...
        {activeTab === "appointment" && (
          ...
          >
            <form onSubmit={handleAppointmentSubmit} className="max-w-lg mx-auto space-y-5">
              ...
              <motion.div variants={fadeUp} custom={1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Mobile Number</label>
                <input
                  type="tel"
                ...
                />
                {errors.mobileNumber && <p className="mt-1 font-['Inter'] text-xs text-red-400">{errors.mobileNumber}</p>}
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div variants={fadeUp} custom={3} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                  <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Preferred Date</label>
                  <input
                    type="date"
                    value={appointment.preferredDate}
                    onChange={e => handleAppointmentChange("preferredDate", e.target.value)}
                    className={`w-full px-4 py-3 rounded-2xl bg-white/5 border font-['Inter'] text-sm text-white transition-all duration-300 focus:outline-none focus:border-[#CBA135]/40 [color-scheme:dark] ${
                      errors.preferredDate ? "border-red-500/50" : "border-white/10"
                    }`}
                  />
                  {errors.preferredDate && <p className="mt-1 font-['Inter'] text-xs text-red-400">{errors.preferredDate}</p>}
                </motion.div>

                <motion.div variants={fadeUp} custom={4} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                  <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Preferred Time</label>
                  <input
                    type="time"
                  ...
                  />
                  {errors.preferredTime && <p className="mt-1 font-['Inter'] text-xs text-red-400">{errors.preferredTime}</p>}
                </motion.div>
              </div>

              <motion.div variants={fadeUp} custom={5} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <label className="block font-['Inter'] text-xs font-medium text-white/60 mb-2">Service Interested In</label>
                <div className="relative">
                  <select
                    value={appointment.service}
                    onChange={e => handleAppointmentChange("service", e.target.value)}
                    className={`w-full px-4 py-3 rounded-2xl bg-white/5 border font-['Inter'] text-sm text-white appearance-none cursor-pointer transition-all duration-300 focus:outline-none focus:border-[#CBA135]/40 ${
                      errors.service ? "border-red-500/50" : "border-white/10"
                    } ${!appointment.service ? "text-white/20" : "text-white"}`}
                  >
                    <option value="" disabled className="bg-[#050505] text-white/40">Select a treatment</option>
                    {treatments.map(t => (
                      <option key={t} value={t} className="bg-[#050505] text-white">{t}</option>
                    ))}
                  </select>
                ...
                {errors.service && <p className="mt-1 font-['Inter'] text-xs text-red-400">{errors.service}</p>}
              </motion.div>
