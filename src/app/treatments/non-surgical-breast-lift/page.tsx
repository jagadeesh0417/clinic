...
const treatment = getTreatmentBySlug("non-surgical-breast-lift");
...
export default function NonSurgicalBreastLiftPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0E]">
      <div className="relative h-[50vh] min-h-[320px] w-full overflow-hidden bg-[#0F0F0E]">
        <img
          src="/images/breastlift-1.png"
          alt="Non-Surgical Breast Lift"
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <p className="mt-3 max-w-2xl font-displayans text-base leading-relaxed text-[#F5F1E8]/60">
              Injectable and energy-based lift for firmer, naturally shaped breasts &mdash; no cuts, no scars.
            </p>
            <div className="mt-5 flex flex-wrap gap-5">
              ...
              <div>
                ...
                <p className="font-displayans text-sm text-[#F5F1E8]/70">1&ndash;3 sessions</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        {/* 1. What is a Non-Surgical Breast Lift? */}
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Section title="What is a Non-Surgical Breast Lift?">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Minimally Invasive", text: "Uses injectables or collagen-stimulating treatments instead of surgery" },
                { label: "No Scarring", text: "No cuts, stitches, or visible scars" },
                { label: "Natural Results", text: "Provides subtle, natural-looking enhancement" },
                { label: "Quick Recovery", text: "Minimal downtime with gradual improvement" },
              ].map(s => (
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-14">
          <Section title="How It Works">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step: "01", text: "Treatment is performed using targeted injections or energy-based technology" },
                { step: "02", text: "Stimulates natural collagen and elastin production" },
                { step: "03", text: "Improves skin firmness and supports breast contour" },
                { step: "04", text: "Results develop gradually with minimal downtime" },
              ].map(s => (
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              {treatment.gallery.map((src, i) => (
                <div key={i} className="group relative aspect-[4/3] overflow-hidden rounded-xl border border-[#F5F1E8]/[0.06]">
                  <img
                    src={src}
                    alt={`Non-Surgical Breast Lift gallery ${i + 1}`}
                    loading="lazy"
        ...
        >
          <p className="font-displayans text-xs text-[#F5F1E8]/30 leading-relaxed max-w-lg mb-6">
            Results and experience may vary. This treatment should only be performed by a qualified medical professional after consultation. Severe sagging may require surgical intervention.
          </p>
