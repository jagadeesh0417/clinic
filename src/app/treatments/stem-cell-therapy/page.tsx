...
const treatment = getTreatmentBySlug("stem-cell-therapy");
    ...
    <div className="min-h-screen bg-[#0F0F0E]">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <p className="mt-3 max-w-2xl font-displayans text-base leading-relaxed text-[#F5F1E8]/60">
              Harness the body's own regenerative cells to restore hair, skin, and tissue &mdash; naturally.
            </p>
            <div className="mt-5 flex flex-wrap gap-5">
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Duration</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">60&ndash;90 min</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Results</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">Visible in 4&ndash;6 weeks, continued over 3&ndash;6 months</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Longevity</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">12&ndash;24 months or longer</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Sessions</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">1&ndash;3 sessions depending on indication</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Section title="What is Stem Cell Therapy?">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Autologous", text: "Uses the patient's own stem cells for zero rejection risk" },
                { label: "Regenerative", text: "Stimulates natural healing and tissue regeneration" },
                { label: "Versatile", text: "Treats hair, skin, joints, and scars in one approach" },
                { label: "Minimal Downtime", text: "Non-surgical biology-based approach with quick recovery" },
              ].map(s => (
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-14">
          <Section title="How It Works">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step: "01", text: "Stem cells are harvested from the patient's own body via minor extraction" },
                { step: "02", text: "The sample is processed and concentrated to isolate regenerative cells" },
                { step: "03", text: "Concentrated solution is injected into the target area" },
                { step: "04", text: "Results develop gradually over weeks to months as regeneration takes place" },
              ].map(s => (
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              {treatment.gallery.map((src, i) => (
                <div key={i} className="group relative aspect-[4/3] overflow-hidden rounded-xl border border-[#F5F1E8]/[0.06]">
                  <img
                    src={src}
                    alt={`Stem Cell Therapy gallery ${i + 1}`}
                    loading="lazy"
        ...
        >
          <p className="font-displayans text-xs text-[#F5F1E8]/30 leading-relaxed max-w-lg mb-6">
            Results and experience may vary. Stem cell therapy should only be performed by a qualified medical professional after consultation and medical evaluation. Regulatory approval and available indications may vary by region.
          </p>
