          ...
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-5 flex flex-wrap gap-5">
              <div>
                ...
                <p className="font-['Inter'] text-sm text-[#F5F1E8]/70">60&ndash;90 min</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Results</p>
                <p className="font-['Inter'] text-sm text-[#F5F1E8]/70">Visible in 4&ndash;6 weeks, continued over 3&ndash;6 months</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Longevity</p>
                <p className="font-['Inter'] text-sm text-[#F5F1E8]/70">12&ndash;24 months or longer</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Sessions</p>
                <p className="font-['Inter'] text-sm text-[#F5F1E8]/70">1&ndash;3 sessions depending on indication</p>
              </div>
            </div>
          </div>
        </div>
