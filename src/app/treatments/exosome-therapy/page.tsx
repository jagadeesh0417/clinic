          ...
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-5 flex flex-wrap gap-5">
              ...
              <div>
                ...
                <p className="font-sans text-sm text-[#F6F1E8]/70">Visible in 2&ndash;4 weeks, continued over 2&ndash;3 months</p>
              </div>
              <div>
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Longevity</p>
                <p className="font-sans text-sm text-[#F6F1E8]/70">6&ndash;12 months</p>
              </div>
              <div>
