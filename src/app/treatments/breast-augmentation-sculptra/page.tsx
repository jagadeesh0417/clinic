...
const treatment = getTreatmentBySlug("breast-augmentation-sculptra");
...
export default function BreastAugmentationSculptraPage() {
    ...
    <div className="min-h-screen bg-[#0F0F0E]">
      <div className="relative h-[50vh] min-h-[320px] w-full overflow-hidden bg-[#0F0F0E]">
        <img
          ...
          alt="Breast Augmentation by Sculptra®"
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        {/* 1. What is Breast Augmentation by Sculptra®? */}
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Section title="What is Breast Augmentation by Sculptra&reg;?">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Implant-Free", text: "Enhances breast shape without surgery or implants" },
                { label: "Collagen-Stimulating", text: "Uses Sculptra\u00ae to stimulate natural collagen" },
                { label: "Gradual Results", text: "Natural enhancement over 6\u201312 weeks" },
                { label: "No Scars", text: "No incisions, anesthesia, or visible scars" },
              ].map(s => (
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-14">
          <Section title="How It Works">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step: "01", text: "Breast area is assessed and mapped for optimal placement" },
                { step: "02", text: "Sculptra\u00ae is injected into the deep layers of the breast" },
                { step: "03", text: "It stimulates natural collagen production over weeks" },
                { step: "04", text: "Volume, firmness, and contour improve gradually" },
              ].map(s => (
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              {treatment.gallery.map((src, i) => (
                <div key={i} className="group relative aspect-[4/3] overflow-hidden rounded-xl border border-[#F5F1E8]/[0.06]">
                  <img
                    src={src}
                    alt={`Breast Augmentation by Sculptra® gallery ${i + 1}`}
                    loading="lazy"
        ...
        >
          <p className="font-displayans text-xs text-[#F5F1E8]/30 leading-relaxed max-w-lg mb-6">
            Results and experience may vary. Sculptra&reg; breast augmentation should only be administered by a qualified medical professional after consultation. Significant size increase or severe sagging may require surgical intervention.
          </p>
