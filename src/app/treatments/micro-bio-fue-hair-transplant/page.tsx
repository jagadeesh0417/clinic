          ...
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-5 flex flex-wrap gap-5">
              <div>
                ...
                <p className="font-sans text-sm text-[#F6F1E8]/70">6&ndash;8 hours</p>
              </div>
              <div>
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Results</p>
                <p className="font-sans text-sm text-[#F6F1E8]/70">Initial growth at 3&ndash;4 months, full at 9&ndash;12 months</p>
              </div>
              <div>
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Longevity</p>
                <p className="font-sans text-sm text-[#F6F1E8]/70">Permanent</p>
              </div>
              <div>
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Sessions</p>
                <p className="font-sans text-sm text-[#F6F1E8]/70">1 session (larger areas may need 2)</p>
              </div>
            </div>
          </div>
        </div>
