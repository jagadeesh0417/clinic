...
const treatment = getTreatmentBySlug("micro-bio-fue-hair-transplant");
...
export default function MicroBioFUEHairTransplantPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0E]">
      <div className="relative h-[50vh] min-h-[320px] w-full overflow-hidden bg-[#0F0F0E]">
        <img
          src="https://images.unsplash.com/photo-1595425964272-5bde354e05fe?w=1600&q=80"
          alt="Micro Bio-FUE Hair Transplant"
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <p className="mt-3 max-w-2xl font-displayans text-base leading-relaxed text-[#F5F1E8]/60">
              Advanced follicular unit extraction with bio-enhancement for dense, natural, permanent hair growth.
            </p>
            <div className="mt-5 flex flex-wrap gap-5">
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Duration</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">6&ndash;8 hours</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Results</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">Initial growth at 3&ndash;4 months, full at 9&ndash;12 months</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Longevity</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">Permanent</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Sessions</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">1 session (larger areas may need 2)</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        {/* 1. What is a Micro Bio-FUE Hair Transplant? */}
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Section title="What is a Micro Bio-FUE Hair Transplant?">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Advanced", text: "Ultra-fine micro-punches for minimal tissue trauma" },
                { label: "Bio-Enhanced", text: "Grafts preserved in PRP or growth factor medium" },
                { label: "No Linear Scar", text: "Virtually scarless healing, short hairstyles remain possible" },
                { label: "Permanent", text: "Transplanted hair is permanent from resistant donor zones" },
              ].map(s => (
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-14">
          <Section title="How It Works">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step: "01", text: "Donor area is trimmed and numbed with local anesthesia" },
                { step: "02", text: "Micro-punches extract individual follicular units with minimal trauma" },
                { step: "03", text: "Grafts are preserved in a bio-enhanced solution to boost viability" },
                { step: "04", text: "Recipient sites are created at precise angles and grafts are implanted" },
              ].map(s => (
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              {treatment.gallery.map((src, i) => (
                <div key={i} className="group relative aspect-[4/3] overflow-hidden rounded-xl border border-[#F5F1E8]/[0.06]">
                  <img
                    src={src}
                    alt={`Micro Bio-FUE Hair Transplant gallery ${i + 1}`}
                    loading="lazy"
        ...
        >
          <p className="font-displayans text-xs text-[#F5F1E8]/30 leading-relaxed max-w-lg mb-6">
            Results and experience may vary. This procedure should only be performed by a qualified medical professional after consultation and donor-area assessment.
          </p>
