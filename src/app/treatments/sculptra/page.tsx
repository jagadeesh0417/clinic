...
const treatment = getTreatmentBySlug("sculptra");
...
export default function SculptraDetailPage() {
        ...
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Section title="What is Sculptra?">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              <div className="rounded-xl border border-[#C9A14A]/10 bg-[#C9A14A]/5 px-4 py-3">
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Mechanism</p>
                <p className="mt-1 font-sans text-sm text-[#F6F1E8]/70">Injectable collagen biostimulator made with poly-L-lactic acid (PLLA)</p>
              </div>
              <div className="rounded-xl border border-[#C9A14A]/10 bg-[#C9A14A]/5 px-4 py-3">
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Approach</p>
                <p className="mt-1 font-sans text-sm text-[#F6F1E8]/70">Restores facial volume gradually by stimulating natural collagen</p>
              </div>
              <div className="rounded-xl border border-[#C9A14A]/10 bg-[#C9A14A]/5 px-4 py-3">
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Results</p>
                <p className="mt-1 font-sans text-sm text-[#F6F1E8]/70">Natural-looking, long-lasting rejuvenation developing over time</p>
              </div>
            </div>
          </Section>
        </motion.div>
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-14">
          <Section title="How It Works">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step: "01", text: "Injected beneath the skin by a trained professional" },
                { step: "02", text: "Stimulates the body's natural collagen production" },
                { step: "03", text: "Collagen gradually restores skin volume and firmness" },
                { step: "04", text: "Results improve over several weeks and can last up to 2 years" },
              ].map(s => (
