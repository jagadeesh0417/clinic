          ...
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-5 flex flex-wrap gap-5">
              <div>
                ...
                <p className="font-['Inter'] text-sm text-[#F5F1E8]/70">30&ndash;45 min</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Results</p>
                <p className="font-['Inter'] text-sm text-[#F5F1E8]/70">Visible after 2&ndash;3 sessions</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-['Inter'] text-sm text-[#F5F1E8]/70">2&ndash;3 initial, maintenance every 6 months</p>
              </div>
            </div>
          </div>
        </div>
