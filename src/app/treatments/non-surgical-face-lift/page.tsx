...
const treatment = getTreatmentBySlug("non-surgical-face-lift");
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0E]">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <p className="mt-3 max-w-2xl font-displayans text-base leading-relaxed text-[#F5F1E8]/60">
              Lift, tighten, and redefine the face using advanced energy-based technology &mdash; no surgery, no scars.
            </p>
            <div className="mt-5 flex flex-wrap gap-5">
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Duration</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">45&ndash;90 min</p>
              </div>
              <div>
                <p className="font-['IBM_Plex_Mono'] text-[10px] tracking-wider uppercase text-[#4A5D3A]">Results</p>
                <p className="font-displayans text-sm text-[#F5F1E8]/70">Immediate tightening, full results in 2&ndash;3 months</p>
              </div>
              <div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        {/* 1. What is a Non-Surgical Face Lift? */}
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Section title="What is a Non-Surgical Face Lift?">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Non-Invasive", text: "Lifts and tightens the skin without incisions" },
                { label: "Energy-Based", text: "Uses RF, ultrasound (HIFU), or thread lifts" },
                { label: "No Scarring", text: "No general anesthesia, no scars, little to no downtime" },
                { label: "Natural Results", text: "Gradual, natural-looking results that improve over months" },
              ].map(s => (
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-14">
          <Section title="How It Works">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step: "01", text: "Face is assessed and mapped to identify areas of laxity and volume loss" },
                { step: "02", text: "Energy is delivered to the deep layers of the skin" },
                { step: "03", text: "Controlled energy stimulates natural collagen and elastin production" },
                { step: "04", text: "Skin gradually tightens and firms as new collagen forms" },
              ].map(s => (
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              {treatment.gallery.map((src, i) => (
                <div key={i} className="group relative aspect-[4/3] overflow-hidden rounded-xl border border-[#F5F1E8]/[0.06]">
                  <img
                    src={src}
                    alt={`Non-Surgical Face Lift gallery ${i + 1}`}
                    loading="lazy"
        ...
        >
          <p className="font-displayans text-xs text-[#F5F1E8]/30 leading-relaxed max-w-lg mb-6">
            Results and experience may vary. This treatment should only be performed by a qualified medical professional after consultation. Severe skin laxity may require surgical intervention.
          </p>
