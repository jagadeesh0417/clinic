          ...
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-5 flex flex-wrap gap-5">
              <div>
                ...
                <p className="font-sans text-sm text-[#F6F1E8]/70">20&ndash;30 min</p>
              </div>
              <div>
                <p className="font-sans text-[10px] tracking-wider uppercase text-[#A67C2E]">Results</p>
                <p className="font-sans text-sm text-[#F6F1E8]/70">Visible after 2 sessions</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-sans text-sm text-[#F6F1E8]/70">2 initial sessions 4 weeks apart, maintenance every 6 months</p>
              </div>
            </div>
          </div>
        </div>
